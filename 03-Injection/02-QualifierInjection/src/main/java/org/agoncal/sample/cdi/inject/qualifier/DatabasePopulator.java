 ...
 */
@DataSourceDefinition(name = "java:global/jdbc/sampleCdiInjectQualifierDS",
        className = "org.apache.derby.jdbc.EmbeddedDriver",
        url = "jdbc:derby:memory:sampleCdiInjectQualifierDB;create=true;user=app;password=app"
)
@Singleton
@Startup
