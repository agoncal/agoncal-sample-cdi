 ...
 */
@DataSourceDefinition(name = "java:global/jdbc/sampleCdiInjectionWithoutCDIDS",
        className = "org.apache.derby.jdbc.EmbeddedDriver",
        url = "jdbc:derby:memory:sampleCdiInjectionWithoutCDIDB;create=true;user=app;password=app"
)
@Singleton
@Startup
