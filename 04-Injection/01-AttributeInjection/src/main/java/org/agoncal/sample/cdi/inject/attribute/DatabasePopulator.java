 ...
 */
@DataSourceDefinition(name = "java:global/jdbc/sampleCdiInjectAttributeDS",
        className = "org.apache.derby.jdbc.EmbeddedDriver",
        url = "jdbc:derby:memory:sampleCdiInjectAttributeDB;create=true;user=app;password=app"
)
@Singleton
@Startup
