 ...
 */
@DataSourceDefinition(name = "java:global/jdbc/sampleCdiInjectConstructorDS",
        className = "org.apache.derby.jdbc.EmbeddedDriver",
        url = "jdbc:derby:memory:sampleCdiInjectConstructorDB;create=true;user=app;password=app"
)
@Singleton
@Startup
